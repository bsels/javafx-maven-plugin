...
///
/// ## Key Parts
/// - [io.github.bsels.javafx.maven.plugin.BaseJavaFXMojo]: Base implementation for JavaFX-related Maven goals
/// - [io.github.bsels.javafx.maven.plugin.FXMLToSourceCodeMojo]: Converts FXML files to Java source code
/// - [io.github.bsels.javafx.maven.plugin.JavaFXJlinkMojo]: Supports creating custom runtime images for
///   JavaFX applications
/// - [io.github.bsels.javafx.maven.plugin.JavaFXRunMojo]: Executes JavaFX applications during the Maven build process

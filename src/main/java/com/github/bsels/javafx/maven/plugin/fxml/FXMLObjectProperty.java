...
///
/// This record encapsulates details about an object's property, including its name, getter method name, type, and value.
...
/// - The `getter` refers to the name of the getter method associated with the property.

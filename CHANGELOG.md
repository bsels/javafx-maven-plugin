...
- `io.github.bsels:semantic-version-maven-plugin`: 1.4.0 -\> 1.4.1
...
- `semantic-version-maven-plugin` from `1.0.0` to `1.3.0`
- `assertj-core` from `3.27.6` to `3.27.7`
- `javafx` from `25.0.1` to `25.0.2`
- `plexus-java` from `1.5.1` to `1.5.2`
- `plexus-archiver` from `4.10.4` to `4.11.0`
...
Fixed missing call to the controller `initialize` method.

## 1.2.0 - 2025-12-30

### Minor

Support `fx:controller` in FXML files.
...
Initial release of the **javafx-maven-plugin**.
